//
//  PersonalPathHealthView.swift
//  OYAN App
//
//  Communication & For Yourself path – Q1: "Денсаулық" means (Health)
//

import SwiftUI

struct PersonalPathHealthView: View {
    ...
    let phrase = "Денсаулық"
    
    var options: [String] {
        selectedLanguage == .english
            ? ["Wealth", "Health", "Strength", "Luck"]
            : ["Богатство", "Здоровье", "Сила", "Удача"]
    }
    
    var correctAnswer: String {
        selectedLanguage == .english ? "Health" : "Здоровье"
    }
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $navigateToNext) {
            PersonalPathDombraView(selectedLanguage: selectedLanguage)
        }
    }
}
...
#Preview {
    NavigationStack {
        PersonalPathHealthView(selectedLanguage: .english)
    }
}

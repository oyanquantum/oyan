//
//  TravellingOyanView.swift
//  OYAN App
//
//  Travelling path – Q2: "What is Oyan doing?" (He is flying by plane)
//

import SwiftUI

struct TravellingOyanView: View {
    ...
    let correctAnswer = "Ол ұшақпен ұшады"
    let options = [
        "Ол ұйықтауға жатады",
        "Ол жол сұрады",
        "Ол ұшақпен ұшады",
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $navigateToNext) {
            TravellingSentenceView(selectedLanguage: selectedLanguage)
        }
    }
}

struct TravellingOyanView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationStack {
            TravellingOyanView(selectedLanguage: .english)
        }
    }
}

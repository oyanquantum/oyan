//
//  WorkSalaryMeaningView.swift
//  OYAN App
//
//  Work & Business path – Q2: "Жалақы алу" means (To receive salary)
//

import SwiftUI

struct WorkSalaryMeaningView: View {
    ...
    let phrase = "Жалақы алу"
    
    var options: [String] {
        selectedLanguage == .english
            ? ["To pay bills", "To receive salary", "To borrow money", "To save money"]
            : ["Платить по счетам", "Получать зарплату", "Занимать деньги", "Копить деньги"]
    }
    
    var correctAnswer: String {
        selectedLanguage == .english ? "To receive salary" : "Получать зарплату"
    }
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $navigateToNext) {
            WorkSentenceView(selectedLanguage: selectedLanguage)
        }
    }
}
...
#Preview {
    NavigationStack {
        WorkSalaryMeaningView(selectedLanguage: .english)
    }
}
